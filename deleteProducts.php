  ...
  <div id="backgroundDiv">
    <div id="headerdiv">
      ...
      <div id="selectionbuttonsdiv">
        ...
        <button class="selectionbuttons">DELETE PRODUCTS</button>
      </div>

      <div id="addproductsdiv">
        <form method="get" action="deleteProducts.php">
          <div id="searchInput">
              ...
              <table id="productTable">
                ...
                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                  <form method='POST' action='php/deleteDataFromProducts.php'>
                    <input type='hidden' name='productNumber' value='" . $row["productNumber"] . "'>
                    <input type='submit' id='productDeleteBut' value='Delete'>
                  </form>
                </td>";
                    echo "</tr>";
                  }
